  ...
  if (user) {
    return (
      <>
        ...
        {/* Dropdown Menu */}
        {dropdownOpen && (
          <div className="fixed lg:absolute inset-0 lg:inset-auto lg:-right-4 lg:right-0 lg:mt-2 lg:min-w-[320px] bg-white lg:rounded-[16px] lg:shadow-lg z-50 lg:border lg:border-[#D9D9D9] flex flex-col max-h-screen lg:max-h-[80vh] overflow-y-auto" style={{ boxShadow: '0px 0px 16px 0px #00000029' }}>
            {/* Mobile Close Button */}
