...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50  py-4 bg-white h-[96px] w-full px-4 md:px-0 border-b border-[#F0F0F0] hidden md:flex">
      <div className="w-full px-4 flex flex-wrap items-center">
        ...
        <div className="w-[1px] h-[16px] bg-[#D9D9D9] ml-[32px]"></div>

        <div className="hidden md:block ml-[32px]">
          <MenuItems />
        </div>
