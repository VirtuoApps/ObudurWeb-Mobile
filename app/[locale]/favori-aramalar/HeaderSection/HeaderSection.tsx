  ...
  return (
    <div className="w-full py-6 sm:py-10">
      <div className="max-w-[1440px] mx-auto flex flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 px-4 sm:px-0">
        ...
        <button className="flex items-center gap-2 bg-[#5E5691] hover:bg-[#4B4578] transition-colors text-white px-4 py-2 rounded-xl font-medium text-sm h-[36px] sm:w-[129px] justify-center">
